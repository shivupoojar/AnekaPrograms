...
namespace ConsoleApp2
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\poojara\Downloads\sentiment labelled sentences\sentiment labelled sentences\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=19,NumberOfTrees=17,MaximumBinCountPerFeature=340,FeatureFraction=0.99999999,LearningRate=0.452456090769933,LabelColumnName=@"col1",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col1"))      
