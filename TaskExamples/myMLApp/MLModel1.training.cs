...
namespace MyMLApp
{
    ...
    {
        public const string RetrainFilePath =  @"G:\My Drive\ANEKA\AnekaPrograms\TaskExamples\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=23,NumberOfTrees=5,MaximumBinCountPerFeature=210,FeatureFraction=0.973248009254134,LearningRate=0.330804730871979,LabelColumnName=@"col1",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col1"))      
